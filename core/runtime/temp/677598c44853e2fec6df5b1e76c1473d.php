<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:101:"F:\phpstudy\PHPTutorial\WWW\we7\addons\make_xyx\core\public/../application/index\view\scenic\add.html";i:1535706827;}*/ ?>
            ...
            uploader.onError = function( code ) {
                layui.use('layer', function(){
                    ...
                    if( code == 'Q_EXCEED_NUM_LIMIT' ){
                        layer.msg('超出上传数量限制',{icon: 5,time:1000});
                    }
    ...
    layui.use('form', function(){
        ...
        form.on('submit(add)', function(data) {
            ...
            if(data.img_path == ''){
                ...
                app.ajaxRequest("<?php echo tp_url('scenic/add'); ?>",'post',data,'',success);
            }
            return false;
        });
    });
